...
var app = (function () {
    ...
    function create_if_block_3(ctx) {
    	var h1, t0, t1, div1, a0, t2, t3, div0, a1, t5, i, t6, a2, t8, t9, script0, t11, script1;
    	...
    	return {
    		c: function create() {
    			...
    			t5 = space();
    			i = element("i");
    			t6 = text("The origin of the 10xEngineer Test is\n    ");
    			a2 = element("a");
    			a2.textContent = "this thread of Shekhar Kirani";
    			...
    			add_location(h1, file, 124, 2, 3048);
    			...
    			add_location(a0, file, 126, 4, 3091);
    			...
    			add_location(a1, file, 144, 6, 3588);
    			...
    			add_location(div0, file, 138, 4, 3438);
    			attr(div1, "class", "flex svelte-1z0666y");
    			add_location(div1, file, 125, 2, 3068);
    			attr(a2, "href", "https://twitter.com/skirani/status/1149302828420067328");
    			add_location(a2, file, 156, 4, 3930);
    			attr(i, "class", "spacing svelte-1z0666y");
    			add_location(i, file, 154, 2, 3864);
    			add_location(script0, file, 162, 2, 4149);
    			add_location(script1, file, 182, 2, 4636);
    		},
    ...
    function create_if_block_2(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(h2, file, 113, 2, 2689);
    			attr(div, "id", "recaptcha");
    			add_location(div, file, 115, 4, 2803);
    			add_location(br, file, 116, 4, 2834);
    			attr(input, "type", "submit");
    			input.value = "Submit";
    			add_location(input, file, 117, 4, 2845);
    			attr(form, "action", "");
    			attr(form, "method", "POST");
    			add_location(form, file, 114, 2, 2726);
    			attr(script, "src", "https://www.google.com/recaptcha/api.js?onload=onloadCallback&render=explicit");
    			script.defer = true;
    			add_location(script, file, 119, 2, 2896);
    ...
    function create_if_block_1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(h2, file, 100, 2, 2345);
    			attr(div, "class", "btn-container flex spacing svelte-1z0666y");
    			add_location(div, file, 101, 2, 2377);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(q, file, 88, 4, 1901);
    			add_location(br, file, 92, 4, 2117);
    			add_location(p, file, 87, 2, 1893);
    			add_location(h1, file, 95, 2, 2152);
    			attr(button, "class", "svelte-1z0666y");
    			add_location(button, file, 97, 4, 2224);
    			attr(div, "class", "btn-container flex spacing svelte-1z0666y");
    			add_location(div, file, 96, 2, 2179);
    ...
    // (103:4) {#each questions[count].r as option, i}
    function create_each_block(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(button, "class", "svelte-1z0666y");
    			add_location(button, file, 103, 4, 2466);
    ...
    function create_fragment(ctx) {
    	var div, t0, main, t1, address, t2, a0, t4, a1, t6, a2;
    	...
    	return {
    		c: function create() {
    			...
    			t6 = text(" | Contribute on\n  ");
    			a2 = element("a");
    			a2.textContent = "Github";
    			attr(div, "id", "fb-root");
    			add_location(div, file, 84, 0, 1833);
    			add_location(main, file, 85, 0, 1858);
    			attr(a0, "href", "https://cajotafer.com");
    			add_location(a0, file, 196, 13, 5056);
    			attr(a1, "href", "https://twitter.com/cajotafer");
    			add_location(a1, file, 197, 2, 5106);
    			attr(a2, "href", "https://github.com/cajotafer/10xengineers");
    			add_location(a2, file, 198, 2, 5176);
    			attr(address, "class", "spacing svelte-1z0666y");
    			add_location(address, file, 195, 0, 5017);
    		},
